...
bn_fentrop <- bestNormalize::bestNormalize(scores_df$spec_fentrop)
scores_df$spec_fentrop_norm <- predict(bn_fentrop, scores_df$spec_fentrop)

# Scale original DV
scores_df <- scores_df %>%
  dplyr::mutate(spec_fentrop_scaled = scales::rescale(spec_fentrop))
```
